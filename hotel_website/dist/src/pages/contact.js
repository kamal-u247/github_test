...
function renderContact(ctx) {
    ...
    <main class="flex-grow">
        ...
        <section class="relative overflow-hidden py-16 lg:py-24 border-b border-slate-200/60 dark:border-slate-800">
            <img src="https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?auto=format&fit=crop&w=1600&q=80" alt="" aria-hidden="true" class="absolute inset-0 w-full h-full object-cover">
...
`;
    return (0, layout_1.renderLayout)({ ...ctx, modalBody: 'Need a custom package or group rate? Reach out directly via the form or email us.', extraState }, { main });
}
