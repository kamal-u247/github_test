...
exports.renderServices = renderServices;
...
function renderServices(ctx) {
    ...
    seasonRate: 'standard',
`;
    return (0, layout_1.renderLayout)({ ...ctx, modalBody: 'Choose a room type or request a custom package for your trip.', extraState }, { main });
}
